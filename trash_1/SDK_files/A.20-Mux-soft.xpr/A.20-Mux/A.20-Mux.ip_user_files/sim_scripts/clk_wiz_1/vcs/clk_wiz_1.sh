...
#
# Generated by Vivado on Sat Sep 15 20:39:03 HST 2018
...
# Script info
echo -e "clk_wiz_1.sh - Script generated by export_simulation (Vivado v2018.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../A.20-Skeleton.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1_clk_wiz.v" \
    "$ref_dir/../../../../A.20-Skeleton.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/twili/kurtis_work/A.20-Skeleton/A.20-Skeleton.cache/compile_simlib/vcs"
  fi
