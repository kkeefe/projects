...
elaborate()
{
  xelab --relax --debug typical --mt auto -L microblaze_v10_0_6 -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L mdm_v3_2_13 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_12 -L lmb_v10_v3_0_9 -L lmb_bram_if_cntlr_v4_0_14 -L blk_mem_gen_v8_4_1 -L axis_infrastructure_v1_1_0 -L fifo_generator_v13_2_2 -L axis_data_fifo_v1_1_17 -L axis_register_slice_v1_1_16 -L axis_dwidth_converter_v1_1_15 -L iomodule_v3_1_3 -L axis_switch_v1_1_16 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot base_mb xil_defaultlib.base_mb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim base_mb -key {Behavioral:sim_1:Functional:base_mb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb base_mb.wdb xsim.dir)
